...
export function SendTokens() {
  ...
  async function handleOnSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const send =
      sendMethod === 'sendToken' ? gatewaySendToken : depositAddressSendToken;
  ...
  return (
    <div>
      <h1 className="text-3xl font-medium text-center">
        {sendMethod === 'sendToken' ? 'Send Token' : 'Deposit Address'}
      </h1>
      <br />
      <div className="flex justify-center">
        <button
          ...
          className={`m-1 btn ${
            sendMethod === 'sendToken' ? 'btn-primary' : 'btn-active btn-ghost'
          }`}
        >
          Gateway Send Token
        </button>
            ...
            <div className="justify-end mt-2 card-actions">
              ...
              >
                ...
                {recipientAddress && (
                  <label className="label">
                    <span className="label-text">
                      Recipient: {truncatedAddress(recipientAddress)}
                    </span>
                  </label>
                )}
                {depositAddress && (
                  <label className="label">
                    <span className="label-text">
                      Deposit Address: {truncatedAddress(depositAddress)}
                    </span>
                  </label>
                )}
                <div>
